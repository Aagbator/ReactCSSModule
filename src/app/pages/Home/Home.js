            ...
            <section className={styles.home}>
                <section className={styles['home-container']}>
                    <div className={styles.content}>
                        <h1>We adopt an innovative approach in providing technology solutions across Africa</h1>
                        <p>
                    ...
                    <div className={styles.logos}>
                        ...
                        <ul>
                            ...
                            <li className={styles.partners}><img src={require('../../../assets/images/partners/zoho.png')}  alt="zoho" /></li>
                        </ul>
                    </div>
                ...
                <section className={styles['services-container']}>
                        <div className={styles['col-1']}>
                           <h2>Our services</h2>
                            <p>We are a modern company, committed to promoting the growth of our customers and their
                                business leveraging technology; providing them access to a global market and
                                supporting their operations through tailored solutions.
                            </p>
                        </div>
                        <div className={styles['col-2']}>
                            <div className={styles['block-container']}>
                                <div className={styles.block}>
                                    ...
                                    <p>Our experienced Business Analysts are helping businesses recognize and analyze
                                        their needs and deliver solutions strategically.
                                    </p>
                                </div>
                                <div className={styles.block}>
                                    <div className={styles['img-container']}>
                                ...
                                <div className={styles.block}>
                                    ...
                                    <p>Over the years, our IT support professionals have worked efficiently
                                        to support technical projects and solutions like application software,
                                        infrastructure software etc., for local and international companies
                                ...
                                <div className={styles.block}>
                                    ...
                                    <p>Our Enterprise software solutions are built for small to large organizations
                                        to improve productivity, efficiency and provide critical solutions
                                        to organizational tasks as a whole.
                                    </p>
                                </div>
                            </div>
                        </div>
